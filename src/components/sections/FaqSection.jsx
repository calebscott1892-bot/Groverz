...
const defaultItems = [
  ...
  },
  {
    ...
    answer:
      "It depends on the type and complexity of your return — individual, business, trust or SMSF work all vary in scope. We always provide a clear fixed-fee quote before we begin, so you'll never be surprised by a bill.",
  },
  {
